...
async function up(knex) {
    ...
    var rolePermissions = [
        { permission: "api::register.register.changeTeacher", roles: [authenticatedRole.id] },
        { permission: "api::register.register.updateClassStatus", roles: [authenticatedRole.id] },
    ];
