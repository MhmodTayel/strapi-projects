...
async function up(knex) {
    ...
    var rolePermissions = [
        { permission: 'api::family-link.family-link.findByEntityId', roles: [authenticatedRole.id] },
        { permission: 'api::family-link.family-link.createOrUpdate', roles: [authenticatedRole.id] },
        { permission: 'api::family-link.family-link.unLinkByEntityId', roles: [authenticatedRole.id] },
    ];
