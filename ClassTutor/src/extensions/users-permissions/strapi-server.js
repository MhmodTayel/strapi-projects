// https://forum.strapi.io/t/create-custom-endpoint-for-users-in-strapi-v4/13724
// BUG Fix unable to populate User in Users-Permissions https://github.com/strapi/strapi/pull/11960 
// BUG https://forum.strapi.io/t/strapi-v4-no-relation-fields-in-user-collection-types/13226

// Create a Refresh Token Feature in your Strapi Application strapi.io blog
...
module.exports = (plugin) => {
    ...
    plugin.controllers.user.custom = (ctx) => {
        console.log('test');
    };
